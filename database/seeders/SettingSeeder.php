            ...
            [
                ...
                <span class="credit">
                    <div class="social-links flex my-2.5">
                        <a class="block w-5 h-5 mr-2.5" href="#" title="Telegram" target="_blank" rel="noopener">
                        ...
                        <a class="block w-5 h-5 mr-2.5" href="#" title="Twitter" target="_blank" rel="noopener">
                        ...
                        <a class="block w-5 h-5 mr-2.5" href="#" title="Facebook" target="_blank" rel="noopener">
                            <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24">
                                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                            </svg>
                        </a>
                        <a class="block w-5 h-5" href="#" title="Instagram" target="_blank" rel="noopener">
