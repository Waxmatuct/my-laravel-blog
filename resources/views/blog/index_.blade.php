            ...
            @forelse ($posts as $post)
                ...
                <article class="posts mb-7 flex flex-wrap md:flex-nowrap border-b-2 pb-2 border-gray border-opacity-10">
                        ...
                        @if ($post->tags->isNotEmpty())
                            <span class="post-tag inline-flex">
                                ...
                                @foreach ($post->tags as $tag)
                                    <a class="text-primary dark:text-primary-darker hover:text-primary dark:hover:text-primary-darker text-xs mr-1 border-b border-primary hover:border-primary dark:hover:border-primary border-opacity-30"
                    ...
                    <div class="post-block md:flex-grow">
                        ...
                        <section class="post-excerpt my-3">
                            <p class="max-w-3xl">{{ Str::words($post->description, 20) }}</p>
                        </section>
