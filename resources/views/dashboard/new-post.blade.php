            ...
            <div class="flex sm:flex-row">
                ...
                <div id="col2" class="pl-10 flex w-1/3 flex-col">
                    ...
                    <div class="mt-5">
                        ...
                        <textarea class="w-full px-5 py-2 text-gray-700 bg-gray-200 rounded" id="description" name="description" rows="3" required="" placeholder="" aria-label="Description">{{ old('description') }}</textarea>
                    </div>
